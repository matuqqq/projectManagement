...
-- AddForeignKey
ALTER TABLE "ServerRolePermission" ADD CONSTRAINT "ServerRolePermission_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "ServerRole"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
